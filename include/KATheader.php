  ...
  <body>
    <header id="header" class="navbar navbar-light sticky-top bg-light">
      <div class="container">
        ...
        <div class="">
            <h1><a id="headText" href="/" style="" class="display-2 text-primary text-decoration-none" > KAT </a></h1>
        </div>
      ...
      <div class="collapse navbar-collapse " id="collapsibleNavbar">
        ...
        <ul class="container-fluid navbar-nav justify-content-end">
          <li class="nav-item col-sm-6">
            <h4 class="text-primary" href="../newPost.php">Welcome <b><?php echo $user ?></b> </h4>
          </li>
